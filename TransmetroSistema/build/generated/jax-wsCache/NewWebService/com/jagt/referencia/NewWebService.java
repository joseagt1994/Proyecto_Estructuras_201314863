 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://servicio.jagt.com/", wsdlLocation = "http://localhost:8080/ServicioWeb/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://servicio.jagt.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioWeb/NewWebService?wsdl");
     ...
     * 
     * @return
     *     returns ServicioWebTransmetro
     */
    @WebEndpoint(name = "ServicioWebTransmetroPort")
    public ServicioWebTransmetro getServicioWebTransmetroPort() {
        return super.getPort(new QName("http://servicio.jagt.com/", "ServicioWebTransmetroPort"), ServicioWebTransmetro.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicioWebTransmetroPort")
    public ServicioWebTransmetro getServicioWebTransmetroPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.jagt.com/", "ServicioWebTransmetroPort"), ServicioWebTransmetro.class, features);
    }
